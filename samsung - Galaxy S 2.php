...
<div id="wrap">
       ...
       <div class="center_content">
       	<div class="left_content">
            ...
            <div class="title"><span class="title_icon"><img src="images/bullet1.gif" alt="" title="" /></span>Samsung Galaxy S 2</div>
        
        	<div class="feat_prod_box_details">
            
            	<div class="prod_img"><a href="samsung - Galaxy S 2.php"><img src="images/Samsung Galaxy S 2.jpg" alt="" title="" border="0" /></a>
                <br /><br />
                ...
                <div class="prod_det_box">
                    ...
                    <p class="details">
The Samsung Galaxy S 2 is the ultimate smart media device. The gorgeous widescreen is wrapped in the sleekest design around. The Galaxy S 2's Dual Core 1.2 GHz processor enables fast and seamless recording and playback of Full HD content. And because of a major new advance in battery technology, the Galaxy S 2 is even slimmer and lighter. 
                    ...
                    <div class="price"><strong>PRICE:</strong> <span class="red">548 $</span></div>
				   ...
				   <?php
						...
						$sql = "SELECT * FROM catalog WHERE title='samsung - Galaxy S 2'";
           ...
           ?>
            ...
            <div class="tabs-container">
                    ...
                    <div style="display: block;" class="tab" id="tab1">
                            ...
                            <ul class="list">
                            <li><a href="#">an ultra-slim 8.49mm form factor, a luxurious design and an amazing 4.3" Super Amoled Plus display for enhanced readability
</a></li>
                            <li><a href="#">The Dual Core Processor provides unsurpassed speed for faster browsing, quicker multi-tasking, a smoother UI, snappier streaming and highly efficient gaming
</a></li>
        ...
        <div class="right_content">
            ...
            <a href="#"><img src="images/au.gif" width="16" height="11" alt="AU" title="" border="0" /></a>
              ...
              <div class="cart">
                 ...
                 <!-- display the quatity and the total prices of the shopping products -->                   
