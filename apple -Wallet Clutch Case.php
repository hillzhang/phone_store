	  ...
	  <!--add the search form -->
       ...
       <div class="center_content">
       	<div class="left_content">
            ...
            <div class="title"><span class="title_icon"><img src="images/bullet1.gif" alt="" title="" /></span>Wallet Clutch</div>
        
        	<div class="feat_prod_box_details">
            
            	<div class="prod_img"><a href="apple -Wallet Clutch Case.php"><img src="images/Wallet Clutch Case .jpg" alt="" title="" border="0" /></a>
                <br /><br />
                ...
                <div class="prod_det_box">
                    ...
                    <p class="details">
						The Michael Kors Wallet Clutch combines your iPhone case with a premium leather designer clutch wallet.<br/>


						>Michael Kors iconic details with a contemporary style<br/>
						>Designer clutch with pockets for credit cards and ID<br/>
						>Michael Kors golden signature logo hardware<br/></p>
                    <div class="price"><strong>PRICE:</strong> <span class="red">79.95 $</span></div>
					...
					<?php
						...
						$sql = "SELECT * FROM catalog WHERE title='apple -Wallet Clutch Case '";
...
?>
            ...
            <div class="tabs-container">
                    ...
                    <div style="display: block;" class="tab" id="tab1">
                                        <p>Highligh </p>
                            <ul class="list">
                            <li><a href="#">Combination iPhone 4 case and functional designer wallet or purse</a></li>
                            <li><a href="#">Soft leather lining for protection against scratching
</a></li>
                            <li><a href="#">Cutouts for play-through functionality
</a></li>
                            <li><a href="#">Easy device access
</a></li>                             <li><a href="#">Snap closure for added security
</a></li>             
                      </ul>
        ...
        <div class="right_content">
            ...
            <a href="#"><img src="images/au.gif" width="16" height="11" alt="AU" title="" border="0" /></a>
              ...
              <div class="cart">
                 ...
                 <!-- display the total items and price of the priducts-->
            ...
            Welcome to our shopping center, here you can find either hot products or new products, our shop are including Apple, Sumang,HTC, and Nokiacontain phone, phone relevent products such as Charge Cable, Bluetooth, Wallet, etc. hopping you can have a happy visit in out shopping website.
             ...
             <div class="right_box">
             	...
             	<div class="title"><span class="title_icon"><img src="images/bullet4.gif" alt="" title="" /></span>Promotions</div> 
                    ...
                    <div class="new_prod_box">
                        <a href="Apple -Wallet Clutch Case.php">Wallet Clutch</a>
                        <div class="new_prod_bg">
                        <span class="new_icon"><img src="images/promo_icon.gif" alt="" title="" /></span>
                        <a href="Apple -Wallet Clutch Case.php"><img src="images/thumb3.gif" alt="" title="" class="thumb" border="0" /></a>
                        </div>           
                    </div>               
