	  ...
	  <!--add the search form -->
       ...
       <div class="center_content">
       	<div class="left_content">
            ...
            <div class="title"><span class="title_icon"><img src="images/bullet1.gif" alt="" title="" /></span>Charge Sync Cable</div>
        
        	<div class="feat_prod_box_details">
            
            	<div class="prod_img"><a href="apple -Charge Sync Cable.php"><img src="images/thumb2.gif" alt="" title="" border="0" /></a>
                <br /><br />
...
This USB 2.0 cable connects your iPhone, iPad or iPod — directly or through a Dock — to your computer's USB port for efficient syncing and charging or to the Apple USB Power Adapter for convenient charging from a wall outlet.
                    ...
                    <div class="price"><strong>PRICE:</strong>18<span class="red"> $</span></div>
					...
					<?php
						...
						$sql = "SELECT * FROM catalog WHERE title='apple -Charge Sync Cable'";
           ...
           ?>
            ...
            <div class="tabs-container">
                    ...
                    <div style="display: block;" class="tab" id="tab1">
                            ...
                            <ul class="list">
                            <li><a href="#">Access to all controls and dock connector</a></li>
                            <li><a href="#">Form-fitting construction</a></li>
                            <li><a href="#">Allows charging while in case</a></li>
                            <li><a href="#">USB 2.0 transfers music and pictures in seconds</a></li>                            
							<li><a href="#">4-foot ChargeSync cable</a></li>             
                            </ul>
                                         <p class="more_details">
                                        </p>                           
                    </div>	
        ...
        <div class="right_content">
            ...
            <a href="#"><img src="images/au.gif" width="16" height="11" alt="AU" title="" border="0" /></a>
              ...
              <div class="cart">
                  ...
                  <!-- display thr quatity and the total prices of the products --> 
