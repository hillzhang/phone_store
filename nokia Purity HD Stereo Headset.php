...
<div id="wrap">
       ...
       <div class="center_content">
       	<div class="left_content">
            ...
            <div class="title"><span class="title_icon"><img src="images/bullet1.gif" alt="" title="" /></span>HD Stereo</div>
        
        	<div class="feat_prod_box_details">
            
            	<div class="prod_img"><a href="nokia Purity HD Stereo Headset.php"><img src="images/HD Stereo.jpg" alt="" title="" border="0" /></a>
                <br /><br />
                ...
                <div class="prod_det_box">
                    ...
                    <p class="details">
Advanced driver technology from Monster. Handsfree simplicity from Nokia. And amazing design. It's time for an incredible audio experience.
Nokia Purity Stereo Headset by Monster
                    ...
                    <div class="price"><strong>PRICE:</strong> <span class="red">45.50 $</span></div>
				   ...
				   <?php
						...
						$sql = "SELECT * FROM catalog WHERE title='nokia Purity HD Stereo Headset '";
           ...
           ?>
            ...
            <div class="tabs-container">
                    ...
                    <div style="display: block;" class="tab" id="tab1">
                            ...
                            <ul class="list">
                            <li><a href="#">In-line mic with phone and music controls for easy management of music and phone calls.
</a></li>
                            <li><a href="#">Dual - core A5 chip</a></li>
                            <li><a href="#">Ultra-soft ear cushions make it easier to listen for longer.
</a></li>
                            <li><a href="#">Sleek design and 4 bold colours to choose from, with matching headset and cables.
</a></li>                                         
                            </ul>
