...
<!-- check whether the value of the inputinformation is empty-->
...
<div id="wrap">
       ...
       <div class="center_content">
       	<div class="left_content">
        	...
        	<div class="feat_prod_box_details">
                 ...
                 <?php
						...
						$username1 = htmlentities($_REQUEST['username'], ENT_QUOTES, 'UTF-8');
						//read the salt
						$salt = $_SESSION['salt'];
						//salted md5 to encrypt input login password in order to compare to the md5
						...
						$sql ="select * from us where username='$username1' and password='$password' ";
						...
						if(OCIFetch($stmt)){
							...
							echo '</div>';
							 ...
							 $day=date('d');
							 $past=$year."/".$month."/".$day;
							$sql ="select * from orderinfor where ORDER_DATE  >= to_date('".$past."', 'yyyy/mm/dd') and username='$username'";
							...
							if($username=="")
							{
							echo'you have no account within three months';
							
							}
							else{
							echo 'This is your three months account:';
							echo  '</br>';
							$sql ="select * from orderinfor where username='$username'  ";
							...
							$qty= htmlentities(OCIResult($stmt,"QTY"), ENT_QUOTES, 'UTF-8');
							$total= htmlentities(OCIResult($stmt,"TOTAL"), ENT_QUOTES, 'UTF-8');
							$photo= htmlentities(OCIResult($stmt,"PHOTO"), ENT_QUOTES, 'UTF-8');
							$now= htmlentities(OCIResult($stmt,"TIME"), ENT_QUOTES, 'UTF-8');
							echo'<tr>';
						   ...
						   echo'</table>';
							...
							echo '</div>';
						 echo'Error, your username or password is wrong, please try again <input type="button" class="register" value="try again" onclick="window.location.href=\'myaccount.html\'"/>';
						 }  
        ...
        <div class="right_content">
            ...
            Welcome to our shopping center, here you can find either hot products or new products, our shop are including Apple, Sumang,HTC, and Nokiacontain phone, phone relevent products such as Charge Cable, Bluetooth, Wallet, etc. hopping you can have a happy visit in out shopping website.contain phone, phone relevent products such as Charge Cable, Bluetooth, Wallet, etc. hopping you can have a happy visit in out shopping website.
             </p>
