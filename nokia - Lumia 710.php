	  ...
	  <!--add the search form -->
       ...
       <div class="center_content">
       	<div class="left_content">
            ...
            <div class="title"><span class="title_icon"><img src="images/bullet1.gif" alt="" title="" /></span>Nokia Lumia 710</div>
        
        	<div class="feat_prod_box_details">
            
            	<div class="prod_img"><a href="nokia - Lumia 710.php"><img src="images/Nokia Lumia 710.jpg" alt="" title="" border="0" /></a>
                <br /><br />
                ...
                <div class="prod_det_box">
                    ...
                    <p class="details">
Want to upgrade to a smartphone, but still love your Nokia? Running Windows Phone Mango on a smooth a 1.4GHz processor, the Nokia Lumia 710 promises to impress. The powerful Windows Phone operating system keeps it simple to stay connected and up to date with live updates on the customisable start screen. 



</p>
                    <div class="price"><strong>PRICE:</strong> <span class="red">310.25 $</span></div>
				   ...
				   <?php
						...
						$sql = "SELECT * FROM catalog WHERE title='nokia - Lumia 710'";
           ...
           ?>
            ...
            <div class="tabs-container">
                    ...
                    <div style="display: block;" class="tab" id="tab1">
                            ...
                            <ul class="list">
                            <li><a href="#">Latest version of the Windows Phone operating system
</a></li>
                            <li><a href="#">Flip to silence - Silence incoming calls by turning your phone face down.
</a></li>
                            <li><a href="#">Usability and performance improvements
</a></li>
                            <li><a href="#">Internet sharing (Wi-Fi Hotspot) - Share your phone's internet connection over Wi-Fi    with up to five other devices or computers.
</a></li>                                          
                            </ul>
